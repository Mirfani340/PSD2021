...
public class grapImplementation<T>
{
...
//foreach loop for getting the vertices
    ...
    public static void main(String args[]){
        ...
        graph.containVertex(3);
        graph.containVertex(5);
    }
